# -*- coding: utf-8 -*-
"""smartprop_dashboard.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ax4XBluH9nxKjAWGpputo23effvgivPZ
"""
...
data = pd.DataFrame({
    "Area": areas,
    "Avg Price (SAR/m²)": np.random.randint(4000, 9000, size=4),
...
st.info(
    "North Riyadh shows the highest demand with moderate risk, "
    "making it a strong candidate for near-term residential investment."
)

# CTA
st.markdown("---")
st.markdown("### 🚀 Want full access?")
